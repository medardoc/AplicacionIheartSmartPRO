...
public class AlimentosActivity extends AppCompatActivity{
    ...
    protected void onCreate(Bundle SavedInstanceState) {
        ...
        double ipJumboLatitud = -32.826639;
        double ipJumboLongitud = -70.601229;

        //Crear objetos Geopoint para la coordenadas definidas.
        GeoPoint IPJumboPoint = new GeoPoint(ipJumboLatitud, ipJumboLongitud);
        //Configura la vista centrada en el IP
        mapView.getController().setZoom(15.0);
        //Centra el mapa en el punto
        mapView.getController().setCenter(IPJumboPoint);

        //Crear marcador para ip Smart fit
        Marker marcadorJumbo = new Marker(mapView);
        //Establecer posición
        marcadorJumbo.setPosition(IPJumboPoint);
        //Establece ancla del marcador
        marcadorJumbo.setTitle("Supermercados Jumbo, Chile");
        //Establece una descripción
        marcadorJumbo.setSnippet("los mejorers alimentos para tu salud.");

        //Agregar los marcadores del mapa
        mapView.getOverlays().add(marcadorJumbo);
    ...
    private void regresarInicio() {
        Intent intent = new Intent(AlimentosActivity.this, PanelActivity.class);
