...
public class ControlPesoActivity extends AppCompatActivity {
    // Variables para los elementos de la interfaz de usuario
    EditText editTextName, editTextDescription;
    Button buttonAdd, buttonUpdate, buttonDelete, buttonVolver;
    ListView listView;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.controlpeso_activity);
    ...
    private void VolverInicio () {
        Intent intent = new Intent(ControlPesoActivity.this, PanelActivity.class);
